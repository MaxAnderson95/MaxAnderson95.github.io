...
<p class="post-lead">What if we could generate a temporary credential each time we needed to authenticate to a cloud service? This would eliminate the risk of leakage and the need for regular rotation.</p>
